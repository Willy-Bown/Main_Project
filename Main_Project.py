...
class Main(tk.Frame):
    ...
    def init_main(self):
        ...
        self.img_add = tk.PhotoImage(file="D:\\add.png")
        ...
        self.img_del = tk.PhotoImage(file="D:\\trashcan.png")
        ...
        self.img_upd = tk.PhotoImage(file="D:\\change.png")
        ...
        # Кнопка поиска
        self.img_search = tk.PhotoImage(file="D:\\seek.png")
        ...
        # Кнопка обновления
        self.img_refresh = tk.PhotoImage(file="D:\\refresh.png")
        ...
        self.tree = ttk.Treeview(root,
                                 columns=("id","name","phone","email","payment"),
                                 height=60,
                                 show="headings")
    ...
    def records(self, name, phone, email, payment):
        self.db.insert_data(name, phone, email, payment)
        self.view_records()
    ...
    def update_record(self, name, phone, email, payment):
        id = self.tree.set(self.tree.selection()[0], "#1")
        self.db.cur.execute("""
            UPDATE users
            SET name = ?, phone = ?, email = ?, payment = ?
            WHERE id = ?
        """, (name, phone, email, payment, id))
        self.db.conn.commit()
        self.view_records()
